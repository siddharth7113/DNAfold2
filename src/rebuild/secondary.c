...
float HB(int i1,int j1,float x1[1000],float y1[1000],float z1[1000])
{
 	...
 	if (d>=8.55&&d<=9.39)   //The pairing formation condition
 	{
		...
		if ((type[i1]=='A'&&type[j1]=='T')||(type[i1]=='T'&&type[j1]=='A'))  		{hb=BetaAU*A;} 
 ...
 float BSt(int i1,int j1,int k1,int k2)  //或许可以用四维数组书写，目前暂且如此吧！
{
     ...
     ||((type[i1]=='T'&&type[k1]=='T')&&(type[j1]=='A'&&type[k2]=='A'))) {B=-7.6-300*0.001*(-21.3-B0);}   // AA/TT  (TT/AA)
else if (((type[i1]=='A'&&type[k1]=='C')&&(type[j1]=='T'&&type[k2]=='G')) 
     ||((type[i1]=='G'&&type[k1]=='T')&&(type[j1]=='C'&&type[k2]=='A'))) {B=-8.4-300*0.001*(-22.4-B0);}   // AC/TG  (GT/CA)
else if (((type[i1]=='A'&&type[k1]=='G')&&(type[j1]=='T'&&type[k2]=='C'))
     ||((type[i1]=='C'&&type[k1]=='T')&&(type[j1]=='G'&&type[k2]=='A'))) {B=-7.8-300*0.001*(-21.0-B0);}   // AG/TC  (CT/GA)
else if ((type[i1]=='A'&&type[k1]=='T')&&(type[j1]=='T'&&type[k2]=='A')) {B=-7.2-300*0.001*(-20.4-B0);}   // AT/TA
else if (((type[i1]=='T'&&type[k1]=='G')&&(type[j1]=='A'&&type[k2]=='C')) 
     ||((type[i1]=='C'&&type[k1]=='A')&&(type[j1]=='G'&&type[k2]=='T'))) {B=-8.5-300*0.001*(-22.7-B0); }   // TG/AC  (CA/GT)
else if (((type[i1]=='G'&&type[k1]=='G')&&(type[j1]=='C'&&type[k2]=='C'))
     ||((type[i1]=='C'&&type[k1]=='C')&&(type[j1]=='G'&&type[k2]=='G'))) {B=-8.0-300*0.001*(-19.9-B0);}   // GG/CC
else if ((type[i1]=='C'&&type[k1]=='G')&&(type[j1]=='G'&&type[k2]=='C')) {B=10.6-300*0.001*(-27.2-B0);}  // CG/GC
else if (((type[i1]=='T'&&type[k1]=='C')&&(type[j1]=='A'&&type[k2]=='G'))
     ||((type[i1]=='G'&&type[k1]=='A')&&(type[j1]=='C'&&type[k2]=='T'))) {B=-8.2-300*0.001*(-22.2-B0); }   // TC/AG  (GA/CT)
else if ((type[i1]=='G'&&type[k1]=='C')&&(type[j1]=='C'&&type[k2]=='G')) {B=-9.8-300*0.001*(-24.4-B0);}   // GC/CG
else if ((type[i1]=='T'&&type[k1]=='A')&&(type[j1]=='A'&&type[k2]=='T')) {B=-7.2-300*0.001*(-21.3-B0); }   // TA/AT
